...
本项目是 **基于springboot的公交线路查询系统**，采用主流 Java Web 技术栈开发，功能完整、结构清晰，非常适合作为毕业设计或课程设计的参考源码。

**仓库名**：`java-project-161-springboot-gong-jiao-xian-lu-cha-xun`

**原始压缩包名**：`springboot161基于springboot的公交线路查询系统`
